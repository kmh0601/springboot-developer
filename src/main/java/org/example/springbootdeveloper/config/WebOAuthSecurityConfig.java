...
public class WebOAuthSecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        http.oauth2Login()
                ...
                // Authorization 요청과 관련된 상태를 세션이 아닌 쿠키에 저장해서 쓸 수 있도록 저장소 설정
                .authorizationRequestRepository(oAuth2AuthorizationRequestBasedOnCookieReppository())
                .and()
        ...
        // /api 로 시작하는 url인 경우 401상태 코드를 반환하도록 예외 처리
    ...
    @Bean TokenAuthenticationFilter tokenAuthenticationFilter() {
        return new TokenAuthenticationFilter(tokenProvider);
    }

    @Bean
    public OAuth2AuthorizationRequestBasedOnCookieRepository oAuth2AuthenticationRequestsBasedOnCookieRepository() {
